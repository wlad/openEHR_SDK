...
public class OptSkeletonBuilder {
    ...
    private final Map<Class, RmObjectSkeletonBuilder> builderMap;
    ...
    private static Map<Class, RmObjectSkeletonBuilder> buildBuilderMap() {
        Reflections reflections = new Reflections(RmObjectSkeletonBuilder.class.getPackage().getName());
        Set<Class<? extends RmObjectSkeletonBuilder>> configs = reflections.getSubTypesOf(RmObjectSkeletonBuilder.class);
        ...
        }).collect(Collectors.toMap(RmObjectSkeletonBuilder::getXmlClass, c -> c));
    }
